...
class login:
    def __init__(self, root):
        ...
        self.bg = ImageTk.PhotoImage(file="33591.jpg")
        ...
        title = Label(Frame_login, text='Login Here', font=('Impact', 35, 'bold'), fg='Orange', bg='white').place(x=130,
                                                                                                                  y=30)
        title = Label(Frame_login, text='Product Management', font=('Goudy old style', 15, 'bold'),
    ...
    def login_function(self):
        ...
        elif self.txt_user.get() == "Dip" and self.txt_pass.get() == "123456":
            self.root.destroy()
            import employee
            employee.employee()
